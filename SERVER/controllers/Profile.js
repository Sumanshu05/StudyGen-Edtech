...
exports.updateProfile = async (req, res) => {
    try {
        //find in how much tym will you secdule the delete profile say 5 , 3 days how is it possible?
...
exports.deleteAccount = async (req, res) => {
    try {
        ...
        //search Chrone Job
        //how can we sechdule the delete job
        //delete user 
...
exports.instructorDashboard = async (req, res) => {
    try {
        ...
        res.status(200).json({
            success: true,
            message: "Full Details of the Instructor",
            courses: courseData 
        })
    } catch (error) {
        console.error(error)
