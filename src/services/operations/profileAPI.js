...
const { GET_USER_DETAILS_API , GET_USER_ENROLLED_COURSES_API , GET_INSTRUCTOR_DATA_API, GET_USER_PURCHASE_HISTORY_API } = profileEndpoints;
...
export async function getUserPurchaseHistory(token) {
    ...
    try {
        ...
        console.log("GET_USER_PURCHASE_HISTORY_API ERROR...........", error)
