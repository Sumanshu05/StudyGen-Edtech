...
export default function MyProfile() {
    ...
    return (
        ...
        <div className="flex flex-col items-start justify-between gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 px-6 sm:flex-row sm:items-center md:px-12">
        ...
        <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 px-6 md:px-12">
        ...
        <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 gap-y-5 sm:grid-cols-2 md:max-w-[700px]">
