    ...
    return (
        <div>
            ...
            justify-between gap-10 text-center text-white">
                <header className="mx-auto py-20 text-3xl font-semibold lg:w-[70%] md:text-4xl">
                    Driving Innovation in Online Education for a 
                    <HighlightText text={" Brighter Future"} />

                    <p className="mx-auto mt-3 text-center text-base font-medium
                    text-richblack-300 lg:w-[95%]">
                        StudyGen is at the forefront of driving innovation in online 
                ...
                -translate-x-1/2 translate-y-[30%] grid-cols-3 gap-3 lg:gap-5 px-4 lg:px-0">
                    <img src={BannerImage1} alt="About Us 1" className="w-full h-full object-cover rounded-md" />
                    <img src={BannerImage2} alt="About Us 2" className="w-full h-full object-cover rounded-md" />
                    <img src={BannerImage3} alt="About Us 3" className="w-full h-full object-cover rounded-md" />
                </div>
            </div>
            </section>
            ...
            <section>
                ...
                justify-between">
                    ...
                    <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                        ...
                        to-[#FCB045] bg-clip-text text-3xl font-semibold text-transparent 
                        md:text-4xl lg:w-[70%]">
                            Our Founding Story
                        </h1>
                        ...
                        <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                            ...
                            platform that could bridge these gaps and enpower individuals from 
                  ...
                  <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                    <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                        ...
                        text-3xl font-semibold text-transparent md:text-4xl lg:w-[70%] ">
                            Our Vision
                        </h1>
                        ...
                        <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                            ...
                            engaging content, fostering dynamic and interactive learning experience.
                        </p>
                    </div>

                    <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                        <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] 
                        text-transparent bg-clip-text text-3xl font-semibold md:text-4xl lg:w-[70%]">
                            Our Mission 
                        </h1>
                        ...
                        <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                            ...
                            in an environment of sharing and dialouge, and we foster this spirit of 
